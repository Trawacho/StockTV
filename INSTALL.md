...
**Alternative: Web-UI unter `/setup`**

Auf dem Pi selbst steht zusätzlich die Seite `http://<IP>:8080/setup` zur Verfügung, über
...
**Hostnamen anpassen** — ebenfalls mit `nmtui` (oder alternativ über `/setup`, siehe oben):
