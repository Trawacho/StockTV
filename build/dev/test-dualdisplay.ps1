...
=============================================================
 ...
 Beispiele:
   ...
   .\test-dualdisplay.ps1 -SecondScreen       # Fenster 2 auf den 2. Bildschirm
...
param(
    ...
    [switch]$SecondScreen,                # Fenster 2 auf den zweiten Bildschirm (statt nebeneinander)
