...
if ($secondary) {
    ...
    # Wichtig: das Spiegel-Fenster ZUERST starten. Das danach gestartete
    # Hauptfenster behaelt dadurch den Tastatur-Fokus (Ziffernblock-Eingabe).
    $mirrorArgs = @(
    ...
    Start-Process -FilePath $browser -ArgumentList $mirrorArgs
