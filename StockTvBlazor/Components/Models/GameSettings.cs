...
namespace StockTvBlazor.Components.Models
{
	public class GameSettings
	{
		...
		{
			var e = Enum.Parse<GameModis>(value.ToString());
			SetModus(e);
		}
		...
		public static GameSettings Load()
		{
			...
			var gamemodus = "1"; // localSettings.Values[nameof(GameModus)] as string;
			var turnspergame = "1"; // localSettings.Values[nameof(TurnsPerGame)] as string;
			var pointsperturn = "1"; // localSettings.Values[nameof(PointsPerTurn)] as string;
		...
		private static bool SetSaveProperty<T>(ref T storage, T value, string propertyName) where T : notnull
		{
