...
- `SettingsService`: Erfolgreiches Laden der Config loggen (`LoadSettingsAsync` loggt aktuell nur `Warning` bei fehlender Datei bzw. `Error` bei Ladefehler, aber keine Info-Zeile bei Erfolg, z.B. mit BahnNummer/Modus)