...
- [x] `UseHttpsRedirection()`/`UseHsts()` aus `Program.cs` entfernen — App bedient nie HTTPS (nur Port 8080 HTTP), erzeugt bei jedem Start nur die sinnlose Warnung "Failed to determine the https port for redirect"
